...
if (!class_exists('CardzNetLibExportAdminClass')) 
{
	
	class CardzNetLibExportAdminClass // Define class
	{
		var $myDBaseObj;
		var $fieldNames;
		...
		{
			$this->myDBaseObj->CheckAdminReferer('cardznetlib_export.php');
		...
		{
			$exportData = $this->GetExport($dbList, $exportHTML);
			echo $exportData;
		}
