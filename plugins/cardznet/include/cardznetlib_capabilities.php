...
if (!class_exists('CardzNetLibCapabilitiesClass')) 
{
	class CardzNetLibCapabilitiesClass // Define class
  	{
		...
		static function GetCapabilitiesSelector($role = '')
		{
			...
			$capabilitiesList = CardzNetLibCapabilitiesClass::GetCapabilities($role);
